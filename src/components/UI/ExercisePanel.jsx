              ...
              <>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {muscleInfo.bestExercises.map((exercise, index) => (
                        <span
                          key={index}
                          className="px-3 py-1.5 bg-fit-500 text-white text-sm rounded-lg font-medium"
                        >
                          {exercise}
                        </span>
                      ))}
                ...
                {muscleInfo.trainingFrequency && (
                  <div>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-fit-50 rounded-lg border border-fit-200">
                      <svg className="w-5 h-5 text-fit-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                      <p className="text-sm text-fit-700">{muscleInfo.trainingFrequency}</p>
                    </div>
                  </div>
                )}
            ...
            {exercises.length === 0 ? (
              ...
              <div className="space-y-3">
                {exercises.map((exercise, index) => (
                  <div
                    key={index}
                    className="group bg-gray-50 rounded-xl p-4 hover:bg-fit-50 hover:border-fit-200 transition-colors cursor-pointer border border-gray-100"
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <svg className="w-4 h-4 text-gray-300 group-hover:text-fit-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className={`p-2 rounded-lg transition-all ${
                          addedExerciseId === exercise.name
                            ...
                            : 'bg-fit-500 text-white hover:bg-fit-600'
                        }`}
                      >
